...
data_aggregated <- na.omit(data_aggregated)
plot(data_aggregated, type="l")

library(qs)
qsave(data_aggregated, "Rt_estimate_reconstruction/incidence_data/reported_cases_epiforecasts.qs")
