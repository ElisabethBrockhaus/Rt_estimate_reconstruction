...
getCaseDataDEU <- function(data_path = "Rt_estimate_reconstruction/ETH/data/DEU", filename = "incidence_data_DEU.csv") {
...
getDataHKG <- function(data_path = "Rt_estimate_reconstruction/ETH/data/HKG", filename = "incidence_data_HKG.csv") {
  filePath <- file.path(data_path, filename)
...
getDataCHEBAG <- function(path = "Rt_estimate_reconstruction/ETH/data/CHE", country = "CHE", filename = "incidence_data_CHE.csv") {
...
getCountryData <- function(countries, tempFile = NULL, HMDtemp = NULL, tReload = 300, v = TRUE) {
  ...
  for (i in seq_len(length(countries))) {
    ...
    if (countries[i] == "BEL") {
      ...
      allDataList[[i]] <- getDataCHE(data_path = "Rt_estimate_reconstruction/ETH/data/CHE")
      ...
      allDataList[[i]] <- getDataHKG(data_path = "Rt_estimate_reconstruction/ETH/data/HKG")
      ...
      allDataList[[i]] <- getDataLIE(data_path = "Rt_estimate_reconstruction/ETH/data/CHE")
...
getCountryPopData <- function(tempFileName = "Rt_estimate_reconstruction/ETH/data/pop_sizes.xls", tReload = 15) {
